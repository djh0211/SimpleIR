...
public class makeKeyword {
    public void mkword(File collection) {
        try {
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                for (int j = 0; j < kl.size(); j++) {
                    Keyword key = kl.get(j);
                    sb.append(key.getString() + ":" + key.getCnt() + "#");
                }
            ...
            try {
                ...
                StreamResult result = new StreamResult(new FileOutputStream(new File("/Users/hadongjun/Documents/SimpleIR/index.xml")));
